      ...
      <div className="relative z-10 flex h-full flex-col gap-8 md:gap-6 p-6 md:p-8 min-h-[420px] md:min-h-0">
        ...
        <div className="flex flex-col items-center gap-6 text-center">
            <div className="w-full flex items-center justify-center">
              <p className={`!text-[72px] md:!text-5xl lg:!text-6xl font-black leading-none whitespace-nowrap tracking-tight drop-shadow-[0_0_30px_rgba(255,215,0,0.55)] ${theme.textAccent} mx-auto text-center`}>{plan.price}</p>
            </div>
